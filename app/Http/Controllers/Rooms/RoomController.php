...
class RoomController extends Controller
{
    public function index()
    {
        ...
        if ($roomName == 'king-lee-suite') {
            ...
            $paragraphTwo = 'Reservations range from $180 to $195 per night. Special event reservations 
            may be slightly higher. All pricing is based on double occupancy. Each additional guest is a 
            rate of $5.00 per night. A single bed (or an infant pack and play) can be placed in the suite, 
            if needed.';
            $minimumPrice = '180';
            ...
            $paragraphTwo = 'Reservations range from $180 to $195 per night. Special event reservations may be
                slightly higher. All pricing is based on double occupancy. Each additional guest is a rate
                of $5.00 per night. A single bed (or an infant pack and play) can be placed in the suite, if needed';
            $minimumPrice = '180';
            ...
            $paragraphTwo = 'Reservations range from $185 to $200 per night. Special event reservations may be
                slightly higher. All pricing is based on double occupancy. Each additional guest is a rate
                of $5.00 per night. A single bed (or an infant pack and play) can be placed in the suite, if
