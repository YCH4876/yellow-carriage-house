...
<div class="gallery-row">
    <div class="row">
        ...
        <div class="col-12 col-lg-4 gallery-image-container-header">
            <img src="{{ asset_v('img/rooms/king-lee/1.jpg') }}" class="gallery-image-header">
        </div>
        <div class="col-lg-4 d-none d-lg-inline gallery-image-container-header">
            <img src="{{ asset_v('img/rooms/king-lee/2.jpg') }}" class="gallery-image-header">
        </div>
        <div class="col-lg-4 d-none d-lg-inline gallery-image-container-header">
            <img src="{{ asset_v('img/rooms/king-lee/3.jpg') }}" class="gallery-image-header">
        </div>
        @elseif($roomName == 'windsor-queen-suite-plus')
        <div class="col-12 col-lg-4 gallery-image-container-header">
            <img src="{{ asset_v('img/rooms/windsor-queen/1.jpg') }}" class="gallery-image-header">
        </div>
        <div class="col-lg-4 d-none d-lg-inline gallery-image-container-header">
            <img src="{{ asset_v('img/rooms/windsor-queen/2.jpg') }}" class="gallery-image-header">
        </div>
        <div class="col-lg-4 d-none d-lg-inline gallery-image-container-header">
            <img src="{{ asset_v('img/rooms/windsor-queen/3.jpg') }}" class="gallery-image-header">
        </div>
        @elseif($roomName == 'the-carriage-house-apartment-suite')
        <div class="col-12 col-lg-4 gallery-image-container-header">
            <img src="{{ asset_v('img\rooms\the-carriage-house-apartment-suite\1.jpg') }}" class="gallery-image-header">
        </div>
        <div class="col-lg-4 d-none d-lg-inline gallery-image-container-header">
            <img src="{{ asset_v('img\rooms\the-carriage-house-apartment-suite\2.jpg') }}" class="gallery-image-header">
        </div>
        <div class="col-lg-4 d-none d-lg-inline gallery-image-container-header">
            <img src="{{ asset_v('img\rooms\the-carriage-house-apartment-suite\3.jpg') }}" class="gallery-image-header">
        </div>
        @endif
    </div>
</div>
    ...
    <div id="gallery" class="container mt-4 mb-5">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 mb-3 mb-sm-0 gallery-image-container">
                <img src="{{ asset_v('img\rooms\king-lee\1.jpg') }}" class="gallery-image ">
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6 mb-3 mb-sm-0 gallery-image-container">
                <img src="{{ asset_v('img\rooms\king-lee\2.jpg') }}" class="gallery-image ">
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6 mb-3 mb-sm-0 gallery-image-container">
                <img src="{{ asset_v('img\rooms\king-lee\3.jpg') }}" class="gallery-image ">
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6 mb-3 mb-sm-0 gallery-image-container">
                <img src="{{ asset_v('img\rooms\king-lee\4.jpg') }}" class="gallery-image ">
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6 mb-3 mb-sm-0 gallery-image-container">
                <img src="{{ asset_v('img\rooms\king-lee\5.jpg') }}" class="gallery-image ">
            </div>
            @elseif($roomName == 'windsor-queen-suite-plus')
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-3 mb-sm-0 gallery-image-container">
                <img src="{{ asset_v('img\rooms\windsor-queen\1.jpg') }}" class="gallery-image ">
            </div>
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-3 mb-sm-0 gallery-image-container">
                <img src="{{ asset_v('img\rooms\windsor-queen\2.jpg') }}" class="gallery-image ">
            </div>
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-3 mb-sm-0 gallery-image-container">
                <img src="{{ asset_v('img\rooms\windsor-queen\3.jpg') }}" class="gallery-image ">
            </div>
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-3 mb-sm-0 gallery-image-container">
                <img src="{{ asset_v('img\rooms\windsor-queen\4.jpg') }}" class="gallery-image ">
            </div>
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-3 mb-sm-0 gallery-image-container">
                <img src="{{ asset_v('img\rooms\windsor-queen\5.jpg') }}" class="gallery-image ">
            </div>
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-3 mb-sm-0 gallery-image-container">
                <img src="{{ asset_v('img\rooms\windsor-queen\6.jpg') }}" class="gallery-image ">
            </div>
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-3 mb-sm-0 gallery-image-container">
                <img src="{{ asset_v('img\rooms\windsor-queen\7.jpg') }}" class="gallery-image ">
            </div>
            @elseif($roomName == 'the-carriage-house-apartment-suite')
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-3 mb-sm-0 mb-3 mb-sm-0 gallery-image-container">
                <img src="{{ asset_v('img\rooms\the-carriage-house-apartment-suite\1.jpg') }}" class="gallery-image ">
            </div>
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-3 mb-sm-0 gallery-image-container">
                <img src="{{ asset_v('img\rooms\the-carriage-house-apartment-suite\2.jpg') }}" class="gallery-image ">
            </div>
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-3 mb-sm-0 gallery-image-container">
                <img src="{{ asset_v('img\rooms\the-carriage-house-apartment-suite\3.jpg') }}" class="gallery-image ">
            </div>
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-3 mb-sm-0 gallery-image-container">
                <img src="{{ asset_v('img\rooms\the-carriage-house-apartment-suite\4.jpg') }}" class="gallery-image ">
            </div>
        </div>
        @endif
    </div>
        ...
        <div class="row ">
            ...
            <div class="col-lg-6 mb-5 mb-lg-0 @if($roomName == 'king-lee-suite')d-none @endif">
                <div class="card shadow">
                    <img src="{{ asset_v('img/rooms/king-lee/1.jpg') }}" class="card-img-top" alt="King Lee Suite Image">
                    <div class="card-body">
